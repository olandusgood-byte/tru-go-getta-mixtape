(() => {
  ...
  function loadCareer(){try{const saved=JSON.parse(localStorage.getItem(CAREER_KEY)||'{}');if(saved&&typeof saved==='object'&&!Array.isArray(saved))Object.assign(career,saved)}catch(e){}}
