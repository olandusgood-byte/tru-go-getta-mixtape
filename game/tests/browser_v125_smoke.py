...
with sync_playwright() as p:
    ...
    check('v125-title',page.title()=='TRU GO GETTA — Game V1.25',page.title())
    ...
    drive_before=page.evaluate("window.TGGGame.getState().x")
    page.evaluate("window.TGGGame.move(2,0)")
    drive_after=page.evaluate("window.TGGGame.getState().x")
    check('drive-speed',drive_after-drive_before>3.0,f'{drive_before}->{drive_after}')
