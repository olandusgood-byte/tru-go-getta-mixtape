(() => {
  ...
  function captureBaseline(){
    ...
    state.baseline={pixelRatio:r.getPixelRatio?.()||window.devicePixelRatio||1,shadowEnabled:!!r.shadowMap?.enabled,crowdEnabled:window.TGGV235?.status?.()?.enabled!==false,effectsEnabled:window.TGGV238?.status?.()?.enabled!==false,lightingQuality:window.TGGV231?.status?.()?.quality||'auto'};
  ...
  function applyTier(id='balanced'){
    ...
    const crowd=window.TGGV235?.status?.();if(crowd){if(cfg.crowd<.5)window.TGGV235?.setEnabled?.(false);else{window.TGGV235?.setEnabled?.(true);if(crowd.enabled===false)window.TGGV235?.rebuild?.()}}
  ...
  function restore(){
    ...
    if(b){window.TGGV235?.setEnabled?.(b.crowdEnabled!==false);window.TGGV238?.setEnabled?.(b.effectsEnabled);window.TGGV231?.setQuality?.(b.lightingQuality)}
