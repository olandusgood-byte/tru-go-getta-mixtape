(()=>{const c=globalThis.__V240CoreUnderTest,a=(x,m)=>{if(!x)throw new Error(m)};
a(c,'V2.40 Audio core API must exist');a(typeof c.profile==='function','profile API');a(typeof c.normalize==='function','normalize API');a(typeof c.attenuation==='function','attenuation API');
