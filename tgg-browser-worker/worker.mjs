const steelBackend = String(process.env.TGG_BROWSER_BACKEND || 'local').trim().toLowerCase();
if (steelBackend === 'steel' && process.env.TGG_STEEL_PATCHED !== '1') {
  process.env.TGG_STEEL_PATCHED = '1';
