const CACHE='tgg-video-studio-v2.5.0';
const SHELL=['./','./index.html','./styles.css?v=2.4.1','./pro-ai.css?v=2.5.0','./app.js?v=2.5.0','./gpu-fx.js?v=2.5.0','./pro-ai.js?v=2.5.0','./manifest.webmanifest'];
